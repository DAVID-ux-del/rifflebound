...
.deck-layer {
  ...
  inset: 0;
  background:
    radial-gradient(circle at center, transparent 0 16px, rgba(255,255,255,.2) 17px 18px, transparent 19px),
    repeating-linear-gradient(45deg, rgba(255,255,255,.08) 0 4px, transparent 4px 9px),
    linear-gradient(145deg, #3958c7, #172869 68%, #0d173e);
  border: 3px solid #d4b75b;
  outline: 2px solid #172869;
  outline-offset: -7px;
  border-radius: 8px;
